...
// 1. 文件存在
for (const f of ['package.json', 'cordis.patch.yml', 'lib/index.js', 'lib/client.js', 'lib/core.mjs', 'web/index.html', 'README.md', 'LICENSE']) {
...
// 5. index.js 可 import 且为 cordis 插件形
try {
...
// 6. client.js 语法(期望 ReferenceError: window 未定义,而非 SyntaxError)
try {
